...
func TestGetCustomersHandler(t *testing.T) {
	...
	handler := http.HandlerFunc(handlers.GetCustomers)
...
func TestAddCustomerHandler(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	handler := http.HandlerFunc(handlers.AddCustomer)
	handler.ServeHTTP(rr, req)
...
func TestDeleteCustomerHandler(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	handler := http.HandlerFunc(handlers.DeleteCustomer)
	handler.ServeHTTP(rr, req)
...
func TestGetCustomerHandler(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	handler := http.HandlerFunc(handlers.GetCustomer)
	handler.ServeHTTP(rr, req)
